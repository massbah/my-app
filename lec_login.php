 ...
 <html>
  ...
  <body>
     ...
     <a href="index.php" class="btn btn-warning">Back</a>
      ...
      <form class="admin-login" method="post" action="phpLecturer/process_login.php" id="lect_login">
        <h2 class="form-signin-heading">Please sign in</h2>
        <label for="id" class="sr-only">Id Number</label>
        <input type="number" id="id"  name="id" class="form-control" placeholder="Enter ID Number" required autofocus>
